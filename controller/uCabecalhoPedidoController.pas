...
type
   ...
   TCabecalhoPedidoController = class
      ...
      public
         ...
         function DeletarCabecalhoPedido(pNumPedido: String): Boolean;
      published
...
function TCabecalhoPedidoController.DeletarCabecalhoPedido(pNumPedido: string): Boolean;
var
   xCabecalhoPedidoDao: TCabecalhoPedidoDao;
   xConexao: TConexao;
begin
   try
      try
         ...
         Result := xCabecalhoPedidoDao.DeletarCabecalhoPedido('NumPedido = ' + pNumPedido);
      finally
         if xCabecalhoPedidoDao <> nil then
            FreeAndNil(xCabecalhoPedidoDao);
         if xConexao <> nil then
