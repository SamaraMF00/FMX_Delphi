   ...
   try
      try
         ...
         if xCliente <> nil then
            ...
            MessageDlg('Cliente não cadastrado!', TMsgDlgType.mtWarning,[TMsgDlgBtn.mbOk],0);
      finally
         if xCliente <> nil then
            FreeAndNil(xCliente);
      end;
   ...
   try
      try
         ...
         begin
            ...
            MessageDlg('Produto não cadastrado!', TMsgDlgType.mtWarning,[TMsgDlgBtn.mbOk],0);
      finally
         if xProdutos <> nil then
...
begin
   ...
   begin
      MessageDlg('Digite um código de produto válido!', TMsgDlgType.mtWarning,[TMsgDlgBtn.mbOk],0);
...
begin
   ...
   begin
      MessageDlg('Digite um código de cliente válido!', TMsgDlgType.mtWarning,[TMsgDlgBtn.mbOk],0);
      if edtCodCliente.CanFocus then
         edtCodCliente.SetFocus;
      Exit;
   end;
...
begin
   ...
   if StrToFloatDef(edtVlrUnitario.Text, 0) = 0 then
   begin
      MessageDlg('Valor unitário deve ser maior que 0.', TMsgDlgType.mtWarning,[TMsgDlgBtn.mbOk],0);
...
begin
   ...
   begin
      MessageDlg('Digite o número do pedido para consulta.', TMsgDlgType.mtWarning,[TMsgDlgBtn.mbOk],0);
      if edtNumPedido.CanFocus then
         edtNumPedido.SetFocus;
      Exit;
   end;
...
begin
   try
      try
         ...
         begin
            MessageDlg('Pedido não cadastrado.', TMsgDlgType.mtWarning,[TMsgDlgBtn.mbOk],0);
            Exit;
         end;
...
begin
   try
      try
         ...
         if MessageDlg('Confirma exclusão do pedido ' + edtNumPedido.Text + '?',
